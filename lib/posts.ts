...
export const posts: Post[] = [
  ...
  // ─── Quintal — artigos individuais por espaço ────────────────────────────────
  {
    ...
    sections: [
      ...
      { h2: 'Quanto custa', content: '<p>Para o Espaço Quintal, os pacotes partem de R$ 6.500 para coberturas de 8 a 10 horas. Consulte o guia de <a href="/blog/quanto-custa-fotografo-casamento-sao-paulo/">preços de fotografia de casamento</a>.</p>',
        table: { caption: 'Espaço Quintal — referência rápida', headers: ['Item', 'Referência'], rows: [['Grupo', 'Quintal (6 unidades)'], ['Conceito', 'Rustic Wedding — patrimônio tombado'], ['Estilo fotográfico', 'Luz natural, texturas históricas'], ['Cobertura recomendada', '8-10 horas'], ['Categoria', 'Campo']] },
      },
      { h2: 'Por que escolher Ivan Dias para o Espaço Quintal', content: '<p>Com 15 anos de experiência e mais de 700 casamentos, Ivan Dias domina a fotografia em patrimônios históricos — luz natural, ausência de flash, preservação da atmosfera. Essa experiência transforma o Espaço Quintal em um álbum à altura do cenário. <a href="/blog/fotografo-casamento-grupo-quintal/">Guia do Grupo Quintal.</a> <a href="/blog/casamento-no-campo-perto-de-sao-paulo/">Casamento no campo.</a> <a href="/contato/">Solicite orçamento.</a></p>' },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Quanto custa', content: '<p>Para a Casa Quintal, os pacotes partem de R$ 5.000 para 6 a 8 horas. Consulte o guia de <a href="/blog/quanto-custa-fotografo-casamento-sao-paulo/">preços de fotografia de casamento</a>.</p>',
        table: { caption: 'Casa Quintal — referência rápida', headers: ['Item', 'Referência'], rows: [['Grupo', 'Quintal (6 unidades)'], ['Conceito', 'Comfort Wedding — residencial'], ['Formato', 'Até 100 convidados'], ['Estilo fotográfico', 'Documental, intimista'], ['Cobertura', '6-8 horas'], ['Categoria', 'Campo']] },
      },
      { h2: 'Por que escolher Ivan Dias', content: '<p>Com 15 anos e 700+ casamentos, Ivan Dias domina a abordagem documental que o Comfort Wedding exige. <a href="/blog/fotografo-casamento-grupo-quintal/">Guia do Grupo Quintal.</a> <a href="/blog/casamento-no-campo-perto-de-sao-paulo/">Casamento no campo.</a> <a href="/contato/">Solicite orçamento.</a></p>' },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Quanto custa', content: '<p>Para a Casinha Quintal, os pacotes de mini wedding partem de R$ 4.500 para 4 a 6 horas. Consulte o guia de <a href="/blog/quanto-custa-fotografo-casamento-sao-paulo/">preços de fotografia de casamento</a>.</p>',
        table: { caption: 'Casinha Quintal — referência rápida', headers: ['Item', 'Referência'], rows: [['Grupo', 'Quintal (6 unidades)'], ['Conceito', 'Mini Wedding — estética francesa'], ['Formato', 'Até 50 convidados'], ['Estilo fotográfico', 'Detalhes editoriais, intimista'], ['Cobertura', '4-6 horas'], ['Categoria', 'Campo']] },
      },
      { h2: 'Por que escolher Ivan Dias', content: '<p>Com 15 anos e 700+ casamentos — incluindo mini weddings intimistas — Ivan Dias domina a cobertura compacta sem perder profundidade. <a href="/blog/fotografo-casamento-grupo-quintal/">Guia do Grupo Quintal.</a> <a href="/blog/casamento-no-campo-perto-de-sao-paulo/">Casamento no campo.</a> <a href="/contato/">Solicite orçamento.</a></p>' },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Quanto custa', content: '<p>Para o Celeiro Quintal, os pacotes partem de R$ 6.000 para 8 a 10 horas. Consulte o guia de <a href="/blog/quanto-custa-fotografo-casamento-sao-paulo/">preços de fotografia de casamento</a>.</p>',
        table: { caption: 'Celeiro Quintal — referência rápida', headers: ['Item', 'Referência'], rows: [['Grupo', 'Quintal (6 unidades)'], ['Conceito', 'Farm Wedding — celeiro rústico'], ['Destaque fotográfico', 'Luz lateral em feixes, madeira'], ['Cobertura', '8-10 horas'], ['Categoria', 'Campo']] },
      },
      { h2: 'Por que escolher Ivan Dias', content: '<p>Com 15 anos e 700+ casamentos, Ivan Dias domina a fotografia com luz natural em ambientes rústicos — o tipo de habilidade que o Farm Wedding exige. <a href="/blog/fotografo-casamento-grupo-quintal/">Guia do Grupo Quintal.</a> <a href="/blog/casamento-no-campo-perto-de-sao-paulo/">Casamento no campo.</a> <a href="/contato/">Solicite orçamento.</a></p>' },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Quanto custa', content: '<p>Para o Chalé Quintal, os pacotes partem de R$ 5.000 para 6 a 8 horas. Consulte o guia de <a href="/blog/quanto-custa-fotografo-casamento-sao-paulo/">preços de fotografia de casamento</a>.</p>',
        table: { caption: 'Chalé Quintal — referência rápida', headers: ['Item', 'Referência'], rows: [['Grupo', 'Quintal (6 unidades)'], ['Conceito', 'Romantic Wedding — conto de fadas'], ['Destaque fotográfico', 'Paleta pastel, tecidos, coerência visual'], ['Cobertura', '6-8 horas'], ['Categoria', 'Campo']] },
      },
      { h2: 'Por que escolher Ivan Dias', content: '<p>Com 15 anos e 700+ casamentos, Ivan Dias adapta a edição ao conceito do espaço — paleta pastel e suave para o Romantic Wedding, mantendo coerência visual do primeiro ao último frame. <a href="/blog/fotografo-casamento-grupo-quintal/">Guia do Grupo Quintal.</a> <a href="/blog/casamento-no-campo-perto-de-sao-paulo/">Casamento no campo.</a> <a href="/contato/">Solicite orçamento.</a></p>' },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Quanto custa', content: '<p>Para o Botânico Quintal, os pacotes partem de R$ 6.000 para 8 a 10 horas. Consulte o guia de <a href="/blog/quanto-custa-fotografo-casamento-sao-paulo/">preços de fotografia de casamento</a>.</p>',
        table: { caption: 'Botânico Quintal — referência rápida', headers: ['Item', 'Referência'], rows: [['Grupo', 'Quintal (6 unidades)'], ['Conceito', 'Fresh Wedding — primavera o ano inteiro'], ['Destaque fotográfico', 'Melhor luz do grupo, reflexos verdes'], ['Cobertura', '8-10 horas'], ['Drone', 'Verificar viabilidade com o espaço'], ['Categoria', 'Campo']] },
      },
      { h2: 'Por que escolher Ivan Dias', content: '<p>Com 15 anos e 700+ casamentos, Ivan Dias domina a fotografia com luz natural filtrada pela vegetação — exatamente o que o Fresh Wedding do Botânico oferece. A luz verde suave que elimina sombras duras é o recurso que transforma fotos boas em fotos memoráveis. <a href="/blog/fotografo-casamento-grupo-quintal/">Guia do Grupo Quintal.</a> <a href="/blog/casamento-no-campo-perto-de-sao-paulo/">Casamento no campo.</a> <a href="/contato/">Solicite orçamento.</a></p>' },
    ],
    faq: [
    ...
    sections: [
      {
        ...
        content: '<p>O Welucci Estaiada é construído ao redor de um conceito visual claro: a Ponte Estaiada como protagonista do cenário. Os espelhos d\'água multiplicam a estrutura da ponte no reflexo, as aberturas arquitetônicas emolduram a skyline e a iluminação interna de alto padrão permite transições suaves entre ambientes sem perda de qualidade fotográfica.</p><p>Para o fotógrafo, cada elemento do espaço é uma oportunidade de composição: o casal com a ponte ao fundo, o brinde com a skyline iluminada, a cerimônia refletida na água. Poucos espaços em São Paulo oferecem tantos recursos visuais nativos — o desafio não é encontrar bons ângulos, é administrar o tempo para cobrir todos eles.</p>',
        h3s: [
          { title: 'A Ponte Estaiada como elemento de identidade visual', content: '<p>A Ponte Estaiada aparece nas fotos como elemento de contexto que identifica o álbum instantaneamente: qualquer pessoa que veja as fotos sabe que o casamento foi em São Paulo, na região mais cosmopolita da cidade. Isso cria uma identidade visual que fotos em salões fechados raramente alcançam. Ivan Dias mapeia os ângulos que incluem a ponte antes do evento — a posição ideal muda conforme o horário, a iluminação noturna e a fase da cerimônia.</p>' },
          { title: 'Espelhos d\'água: composição em múltiplos planos', content: '<p>Os espelhos d\'água do Welucci Estaiada criam uma segunda dimensão em cada foto — o casal aparece duas vezes, a arquitetura se duplica, a iluminação ganha profundidade. O fotógrafo que sabe posicionar a câmera na altura certa do espelho produz imagens com uma simetria e riqueza visual que definem o nível do álbum.</p>' },
          { title: 'Skyline noturna: a festa como cenário cinematográfico', content: '<p>Quando o sol se põe e a iluminação urbana acende, o Welucci Estaiada revela seu segundo cenário: a skyline de São Paulo como pano de fundo da festa. Essa transição — do golden hour à noite iluminada — é o momento mais fotogênico do evento e exige do fotógrafo preparação para mudar completamente o setup de câmera em minutos.</p>' },
        ],
      },
      {
        h2: 'Por que o Estaiada exige um fotógrafo com domínio de luz mista urbana',
        content: '<p>O Welucci Estaiada combina luz natural (golden hour, luz difusa das aberturas), iluminação artificial interna (LED, spots) e a iluminação urbana noturna (skyline, ponte iluminada). Essa mistura de fontes de luz com temperaturas de cor diferentes é o desafio técnico central de fotografar neste espaço.</p><p>O fotógrafo que não domina balanço de branco em tempo real e configuração de flash em ambientes de luz mista entrega fotos com tons amarelados na pista de dança, tons azulados nas áreas com luz urbana e inconsistência de cor ao longo do álbum. Ivan Dias calibra o equipamento para cada zona do espaço durante a visita técnica prévia — eliminando essas variações antes que aconteçam.</p>',
        h3s: [
          { title: 'Transição golden hour → noite: o momento crítico', content: '<p>Os 30 minutos entre o pôr do sol e a escuridão total são o período mais fotogênico — e mais exigente tecnicamente — de um casamento no Estaiada. A luz muda rapidamente, os cenários de fundo se transformam e o fotógrafo precisa acompanhar essa mudança com ajustes constantes. Ivan Dias planeja esse momento como prioridade absoluta no cronograma.</p>' },
        ],
      },
      {
        h2: 'Logística do dia no Welucci Estaiada — tempo de cobertura recomendado',
        content: '<p>Para aproveitar os cenários do Estaiada em todas as condições de luz (dia, golden hour, noite), a cobertura recomendada é de 10 a 12 horas. Coberturas mais curtas (6-8h) funcionam, mas perdem ou o golden hour ou os registros noturnos com a skyline — e esses são frequentemente os frames que definem o álbum.</p>',
        table: {
          caption: 'Welucci Estaiada — referência rápida',
          headers: ['Item', 'Referência'],
          rows: [
            ['Localização', 'Cidade Monções, São Paulo'],
            ['Grupo', 'Welucci (parte das 13 unidades)'],
            ['Cenário principal', 'Vista Ponte Estaiada + espelhos d\'água'],
            ['Estilo predominante', 'Urbano sofisticado, cosmopolita'],
            ['Cobertura recomendada', '10-12 horas (dia + golden hour + noite)'],
            ['Drone', 'Verificar regulamentação local (zona urbana densa)'],
          ],
        },
      },
      {
        h2: 'Por que escolher Ivan Dias para o Welucci Estaiada',
        content: '<p>Com 15 anos de experiência e mais de 700 casamentos fotografados em São Paulo, Ivan Dias domina a complexidade técnica de espaços urbanos sofisticados como o Welucci Estaiada. A experiência com luz mista, transições de cenário e composições arquitetônicas é o que transforma um espaço excepcional em um álbum à altura. Ivan Dias atende casamentos em todas as unidades do <a href="/blog/fotografo-casamento-grupo-welucci/">Grupo Welucci</a>. <a href="/blog/casamento-na-cidade-sao-paulo/">Veja o guia de casamento na cidade.</a> <a href="/contato/">Solicite orçamento.</a></p>',
      },
    ],
    faq: [
      { question: 'Ivan Dias atende casamentos no Welucci Estaiada?', answer: 'Sim — Ivan Dias atende casamentos em todas as unidades do Grupo Welucci, incluindo o Estaiada. Entre em contato para verificar disponibilidade.' },
      { question: 'A Ponte Estaiada aparece nas fotos do casamento?', answer: 'Sim — com o ângulo certo, a Ponte Estaiada é o elemento de identidade visual mais forte do espaço. Ivan Dias mapeia os ângulos ideais durante a visita técnica e reserva momentos do cronograma para esses registros.' },
      { question: 'Os espelhos d\'água aparecem nas fotos?', answer: 'Sim — posicionando a câmera na altura correta, os espelhos criam reflexos que dobram visualmente o casal e a arquitetura, produzindo composições com profundidade e simetria únicas.' },
      { question: 'Qual o melhor horário para cerimônia no Estaiada?', answer: 'O fim de tarde oferece a melhor combinação: cerimônia com luz natural, ensaio no golden hour e festa com skyline iluminada. Ivan Dias planeja o cronograma para aproveitar todas as fases de luz.' },
      { question: 'Drone funciona no Welucci Estaiada?', answer: 'A região da Cidade Monções tem regulamentação urbana densa. Ivan Dias verifica a viabilidade e a regulamentação antes de cada evento — em muitos casos, os ângulos das áreas elevadas do próprio espaço compensam a ausência de drone.' },
      { question: 'Quanto custa fotografar no Welucci Estaiada?', answer: 'Os pacotes para o Estaiada partem de R$ 7.500 para cobertura completa (10-12h). Solicite orçamento personalizado pelo WhatsApp.' },
    ],
  },

  {
    ...
    sections: [
      ...
      {
        h2: 'Por que o Single exige um fotógrafo com olhar intimista',
        content: '<p>Casamentos em espaços compactos e sofisticados exigem do fotógrafo uma abordagem mais documental e menos intervencionista. O excesso de direcionamento ("olha aqui", "vira pra lá") quebra a naturalidade que espaços intimistas propiciam. Ivan Dias trabalha o Single com câmera discreta e presença sutil — o registro acontece sem que os convidados percebam estar sendo fotografados, o que produz expressões genuínas e momentos espontâneos.</p>',
      },
      {
        h2: 'Logística do dia no Welucci Single — tempo de cobertura recomendado',
        content: '<p>Para casamentos intimistas no Single, a cobertura de 6 a 8 horas cobre todos os momentos com margem: preparação (se no local), cerimônia, fotos do casal, recepção e festa. Coberturas mais longas (10h) permitem incluir making of em outro local e ensaio externo nos arredores de Moema.</p>',
        table: {
          ...
          rows: [
            ...
            ['Cobertura recomendada', '6-8 horas'],
            ['Pré-wedding', 'Parque Ibirapuera (5 min) como opção'],
          ],
        },
      },
      {
        h2: 'Por que escolher Ivan Dias para o Welucci Single',
        content: '<p>Com 15 anos de experiência e mais de 700 casamentos fotografados, Ivan Dias domina a abordagem documental que espaços intimistas exigem — presença discreta, leitura rápida dos momentos e a sensibilidade de capturar emoções sem intervir. O Welucci Single com o fotógrafo certo entrega um álbum com profundidade que casamentos em espaços maiores raramente alcançam. <a href="/blog/fotografo-casamento-grupo-welucci/">Guia do Grupo Welucci.</a> <a href="/blog/casamento-na-cidade-sao-paulo/">Casamento na cidade.</a> <a href="/contato/">Solicite orçamento.</a></p>',
      },
    ],
    faq: [
      { question: 'Ivan Dias atende casamentos no Welucci Single?', answer: 'Sim — Ivan Dias atende todas as unidades do Grupo Welucci, incluindo o Single em Moema. Entre em contato para verificar disponibilidade.' },
      { question: 'O Welucci Single é indicado para mini wedding?', answer: 'Sim — a escala do espaço o torna ideal para celebrações intimistas. A proximidade entre fotógrafo e convidados produz registros com profundidade emocional que casamentos grandes raramente permitem.' },
      { question: 'Qual a vantagem de casar em Moema para a fotografia?', answer: 'Moema fica a 5 minutos do Parque Ibirapuera — opção excelente para ensaio externo do casal no mesmo dia. A região é arborizada e tem luz urbana agradável para registros de transição.' },
      ...
      { question: 'Preciso de segundo fotógrafo no Single?', answer: 'Em casamentos intimistas, geralmente não — um fotógrafo experiente cobre todos os momentos com qualidade. Para eventos maiores no espaço, o segundo fotógrafo pode ser incluído no pacote.' },
      { question: 'O ensaio pré-wedding pode ser feito no próprio espaço?', answer: 'Confirme diretamente com o espaço a disponibilidade para ensaios prévios. O acabamento premium do Single produz imagens bonitas para pré-wedding em estúdio sofisticado.' },
    ],
  },
    ...
    sections: [
      {
        ...
        content: '<p>O conceito zen do Sansu se traduz em fotografia de forma direta: composições limpas, fundos sem poluição visual e uma paleta de cores naturais que cria coerência no álbum inteiro. Os jardins japoneses, com pedras, água e vegetação posicionada com intenção, formam cenários prontos que o fotógrafo apenas precisa enquadrar.</p><p>A decoração interna segue o mesmo minimalismo — o casal é sempre o protagonista do frame. Sem excessos visuais competindo pela atenção, cada foto ganha clareza e elegância naturalmente.</p>',
        h3s: [
          { title: 'Jardins zen como pontos fotográficos independentes', content: '<p>Os jardins do Sansu funcionam como cenários fotográficos completos antes mesmo de incluir o casal. Com pedras, água corrente e vegetação planejada, cada ângulo já possui composição natural. O fotógrafo que conhece esses pontos antecipadamente aproveita cada um no momento certo de luz.</p>' },
          { title: 'Luz natural filtrada pela vegetação', content: '<p>A vegetação do Sansu filtra a luz solar de maneira orgânica, criando padrões de luz e sombra que suavizam a pele e eliminam sombras duras. Ivan Dias aproveita esses padrões para retratos com textura e profundidade impossíveis de replicar em estúdio.</p>' },
          { title: 'Interior minimalista que favorece o casal', content: '<p>Paredes limpas, mobiliário essencial e iluminação planejada garantem que o casal seja o centro visual de cada foto interna. Sem competição de elementos decorativos excessivos, a emoção do momento fala por si.</p>' },
        ],
      },
      ...
      {
        h2: 'Por que o Sansu exige um fotógrafo com sensibilidade contemplativa',
        content: '<p>O estilo zen do Sansu convida a uma abordagem fotográfica mais contemplativa — observação antes de intervenção, respeito ao ritmo natural do evento, câmera discreta. O fotógrafo que chega com flash agressivo e direcionamento excessivo quebra a atmosfera que o espaço leva décadas cultivando. Ivan Dias adota a abordagem documental com olhar artístico que o conceito oriental exige.</p>',
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Cobertura recomendada', '8-10 horas'],
            ['Categoria', 'Interior'],
          ],
        },
      },
      {
        h2: 'Por que escolher Ivan Dias para o Welucci Sansu',
        content: '<p>Com 15 anos de experiência e mais de 700 casamentos, Ivan Dias tem a sensibilidade que espaços zen exigem: presença discreta, leitura de luz natural e a capacidade de transformar o minimalismo do Sansu em imagens com impacto máximo. <a href="/blog/fotografo-casamento-grupo-welucci/">Guia do Grupo Welucci.</a> <a href="/blog/casamento-no-interior-de-sao-paulo/">Casamento no interior.</a> <a href="/contato/">Solicite orçamento.</a></p>',
      },
    ],
    faq: [
      ...
      { question: 'Como é o deslocamento de SP até o Sansu?', answer: 'Cerca de 100 km pela Castelo Branco (SP-280). Ivan Dias prevê margem de 1h30 para o trajeto e sai de SP com antecedência calibrada para o horário do evento.' },
      { question: 'Pré-wedding nos jardins do Sansu é possível?', answer: 'Confirme com o espaço a disponibilidade para ensaios prévios. Os jardins zen são cenários excepcionais para pré-wedding — especialmente no fim de tarde, quando a luz é mais suave.' },
    ],
  },
