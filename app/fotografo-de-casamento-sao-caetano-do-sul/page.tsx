      ...
      <section className="bg-blue-deep py-20 text-cream">
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              {
                title: 'Especialista em casamentos intimistas',
                desc: 'São Caetano tem perfil sofisticado — trabalhamos com cuidado redobrado nos detalhes de cada celebração.',
              },
              {
                title: 'Experiência no ABC',
                desc: 'Conhecemos as locações, a luz e a logística dos principais espaços de São Caetano e região.',
              },
              {
                title: 'Cobertura completa',
                desc: 'Do making of à festa, cada instante registrado com atenção e sensibilidade.',
              },
              {
      ...
      <section className="bg-blue-deep py-16 text-cream">
        <div className="mx-auto max-w-3xl px-6 text-center md:px-12">
          ...
          <blockquote className="mt-6 font-heading text-xl italic md:text-2xl">
            Ivan capturou cada detalhe do nosso casamento em São Caetano com uma sensibilidade incrível.
            As fotos emocionam toda vez que olhamos.
          </blockquote>
          <p className="mt-4 font-body text-sm text-cream/60">— Casal atendido em São Caetano do Sul</p>
        </div>
      </section>
