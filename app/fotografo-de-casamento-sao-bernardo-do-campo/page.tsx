...
export const metadata: Metadata = {
  title: 'Fotógrafo de Casamento em São Bernardo do Campo | Ivan Dias',
  description:
    'Ivan Dias, fotógrafo de casamento em São Bernardo do Campo e ABC Paulista. Cobertura completa, pré-wedding e mini wedding com mais de 700 casamentos registrados. Solicite orçamento.',
  keywords: pageKeywords['sao-bernardo'],
  alternates: { canonical: CANONICAL },
  openGraph: {
    title: 'Fotógrafo de Casamento em São Bernardo do Campo | Ivan Dias',
    description:
      'Fotografia de casamento em São Bernardo do Campo e ABC Paulista. Cobertura completa, pré-wedding e mini wedding.',
    url: CANONICAL,
  },
};
...
const faqItems = [
  {
    question: 'Ivan Dias atende casamentos em São Bernardo do Campo?',
    answer:
      'Sim, atendo casamentos em São Bernardo do Campo e em toda a região do ABC Paulista — Santo André, São Caetano do Sul e cidades vizinhas.',
  },
  {
    question: 'Quanto custa um fotógrafo de casamento em São Bernardo do Campo?',
    answer:
      'Os pacotes para casamentos em São Bernardo do Campo partem de R$ 3.200, com cobertura completa do making of à festa, incluindo edição profissional e entrega em galeria digital de alta resolução. Solicite um orçamento personalizado pelo WhatsApp.',
  },
  {
    question: 'Você atende mini weddings em São Bernardo do Campo?',
    answer:
      'Sim, atendo mini weddings com até 80 convidados em São Bernardo do Campo e região. Temos pacotes específicos para cerimônias intimistas com o mesmo cuidado fotográfico de uma grande celebração.',
  },
  {
    question: 'É possível fazer o ensaio pré-wedding em São Bernardo do Campo?',
    answer:
      'Sim, São Bernardo do Campo tem espaços variados — sítios, reservas naturais e áreas urbanas — perfeitos para ensaios pré-wedding autênticos e memoráveis.',
  },
];
  ...
  '@graph': [
    {
      ...
      description: 'Fotógrafo de casamento em São Bernardo do Campo e ABC Paulista.',
      url: CANONICAL,
      telephone: '+55-11-95302-5177',
      areaServed: { '@type': 'Place', name: 'São Bernardo do Campo, SP, Brasil' },
      priceRange: '$$$',
    },
    {
      '@type': 'Service',
      name: 'Fotografia de Casamento em São Bernardo do Campo',
      ...
      <section className="bg-blue-deep py-20 text-cream">
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          <h2 className="font-heading text-3xl font-bold tracking-tightest md:text-4xl">
            Por que Ivan Dias em São Bernardo do Campo?
          </h2>
